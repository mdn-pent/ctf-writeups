...
![[Pasted image 20250720113101.png]]
...
![[Pasted image 20250720114027.png]]

The text is _reflected back_ on the web page. This immediately makes me think of two common vulnerabilities, that being [[Cross-site Scripting (XSS)]]or [[Server Side Template Injection (SSTI)]]. 

## Burp Suite

To further explore these potentials, let’s hop into [[BurpSuite]] and intercept a request and play around with the parameters.
...
[[Exploit]] Article - [[CVE-2022-29078]]

https://eslam.io/posts/ejs-server-side-template-injection-rce/?source=post_page-----156eff2b6dee---------------------------------------

**PoC**

![[Pasted image 20250720114815.png]]

Now, we can use it to obtain a [[Shell]], first by using our web server to serve a [[Reverse Shell]] [[Payload]], we create teh [[Payload]] :
...
Set up the listener with [[Netcat]] and execute it by pasting it in the password field after the password :
