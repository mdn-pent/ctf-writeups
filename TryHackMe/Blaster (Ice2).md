...
This Machine is the continuum of [[Ice]] room .

Root the [[Windows]]  machine
# Scenario
...
Now that we've launched our target, let's perform some basic [[Enumeration]] of the services running on it! We can use [[Rustscan]] and pass the results to [[Nmap]] :
...
![[Pasted image 20250718133715.png]]
### Gobuster

We can use [[Gobuster]] for [[Fuzzing]] the [[Website]] :
...
![[Pasted image 20250718134932.png]]
We have a username : **Wade

![[Pasted image 20250718135423.png]]
![[Pasted image 20250718135504.png]]

And a [[Wordpress]] login page :

![[Pasted image 20250718135529.png]]

We can try to access with Wade: parzival :
![[Pasted image 20250718135907.png]]
![[Pasted image 20250718135851.png]]
...
![[Pasted image 20250718140247.png]]

# Privilege Escalation

We can start [[Privilege Escalation]] , now that we've gained access to our target system, let's see if we can find a way to escalate. To start, let's scout around the system to see if we can find anything of interest :
...
![[Pasted image 20250718141708.png]]

We go to show more details :

![[Pasted image 20250718141746.png]]
...
![[Pasted image 20250718144612.png]]

We can now open the [[CMD]] and confirm we are Administrators : In the folder area search for **cmd.exe** and press enter.

![[Pasted image 20250718144840.png]]
