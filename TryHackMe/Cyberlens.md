...
We can copy it in a file in our working dir and execute it with [[Python]] 3 :
...
Now we setup our listener on the port we enter in the [[Payload]] with [[Netcat]] :
