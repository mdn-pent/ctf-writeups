...
So a lot of them are just [[MSRPC]] .
# Enumeration

## HTTP (8080)

We can start [[Enumeration]] visiting the [[Webpage]] on 8080, we know it's [[Apache]] 2.4.23 (OpenSSL/1.0.2h PHP/5.6.28) :

![[Pasted image 20250719190227.png]]


![[Pasted image 20250719190738.png]]
...
Now let's run the [[Python]] [[Exploit]] and see what it asks for :
...
We have a root [[Shell]] on the system so let's find the root flag :
...
We can see the flag directly on the [[Website]] too :

![[Pasted image 20250719195750.png]]


We can find 'Lab' user [[NTML]] hash code in SAM file so let's download it and crack the code :
