...
We can write etc/hosts, during enumeration in the machine we can see also there's a cronjob hitting on the website, we can modify it and get a root [[Shell]], first we modify the /etc/host file :
