...
We can start [[Enumeration]] on [[FTP]] port :
...
so we have a name Jake and we know he had a weak password, maybe he didn't change that, we can try on [[SSH]].
## SSH Bruteforce Exploit

### Hydra

We can [[Bruteforcing]] with [[Hydra]]
...
now we can find the first [[Flag]]  :
...
For [[Privilege Escalation]] we first check sudo commands for user jake :
...
we can see we have sudo for **[[Less]]** .

### GTFObins

Using [[GTFObins]] we search for SUDO - less :

![af573d8a895fa379e07c75476177ef3e.png](af573d8a895fa379e07c75476177ef3e.png)
...
we can crack the password with [[Stegcracker]].
...
and it uses it for us , now we can access Holt [[SSH]] .
...
For [[Privilege Escalation]] we check and we can run [[Nano]] as root :
...
We go to [[GTFObins]] and we search for SUDO - nano :

![7c5dc059942a76ca3c419adce424a8bc.png](7c5dc059942a76ca3c419adce424a8bc.png)

![f39047c490628f88078360da397024f8.png](f39047c490628f88078360da397024f8.png)
